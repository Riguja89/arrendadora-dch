  ...
  return (
    <main className="container">
      <header className="portal-hero">
        {/* La marca (logo + nombre) vive ahora en el header global compartido
            (`HeaderPortal`, RN-L07). El hero del catálogo conserva un eyebrow
            textual para mantener la jerarquía sin duplicar el logo. */}

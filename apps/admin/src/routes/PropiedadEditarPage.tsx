 ...
 * y ubicación (ADR-011). El backend ya restringe el detalle a las propias para Agente (RN-010);
 * un 403/404 aquí se muestra tal cual, sin intento de bypass en el cliente.
 */
